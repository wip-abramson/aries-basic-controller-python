...
async def main(
    ...
    try:
        ...
        #     timing=show_timing,
        # )
        agent = AriesAgentController(webhook_host=DATA_WEBHOOK_HOST, webhook_port=DATA_WEBHOOK_PORT,
                                                     webhook_base=DATA_WEBHOOK_BASE, admin_url=DATA_ADMIN_URL,
                                                     connections=True)

        # await agent.listen_webhooks(start_port + 2)
        await agent.listen_webhooks(DATA_WEBHOOK_PORT)
        ...
        with log_timer("Generate invitation duration:"):
            ...
            connection = await agent.connections_controller.admin_POST("/connections/create-invitation")
